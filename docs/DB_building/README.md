...
To detect interactions, we are utilizing the post-translational dataset from OmniPath (${\color{red}link!!}$). The creators of the network have acknowledged that it may include a significant number of false positives. 
