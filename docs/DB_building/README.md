...
Example: lets assume ${\color{red}a}$ complex ${\color{red}ligand}$ G1_G2 ~~G3~~ is linked to ${\color{red}a}$ ~~another~~ complex ${\color{red}receptor}$ ${\color{red}G3}$ _G4 ~~G5_G6~~. We break ${\color{red}it}$ down into components and produce ~~all the possible~~ pairwise combinations.
