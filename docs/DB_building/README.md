...
We utilize two main interaction databases from Omnipath <span style="color:#f03c15;"> Some green text </span>. To retrieve the databases we make use of OmnipathR package which is a client for the OmniPath web service (https://www.omnipathdb.org) and many other resources (Valdeolivas et al., 2019).
